...
<link href="<%=basePath%>/resources/tree/css/demo.css" rel="stylesheet" media="all">
<link href="<%=basePath%>/resources/css/my.css" rel="stylesheet" media="all" />
</head>
<body>
	<div class="layui-container" style="margin-top: 20px; width: 100%;">
				...
				<div>
					<table id="proMet_table"
						class="layui-table backlog_table " lay-even
						lay-skin="nob">
						<colgroup>
							<col>
							<col>
					...
					<div class="layui-inline">
						...
						<div class="layui-input-inline">
							<input type="text" id="triDescription" name="triDescription"
								lay-verify="triDescription" autocomplete="off" class="layui-input">
						</div>
					</div>
				</div>
				<div class="layui-form-item">
					...
					<div class="layui-inline">
						...
						<div class="layui-input-inline">
							<input type="text" id="triWebbot" name="triWebbot" lay-verify="triWebbot"
...
<script type="text/javascript">
	...
	function drawTable(pageInfo) {
		...
		for (var i = 0; i < list.length; i++) {
			...
			trs += '<tr data-metauid="'
					+ meta.triUid
					+ '"><td><input type="checkbox" name="eCheck" value="' + meta.triUid + '" lay-skin="primary">'
	...
	$(".sure_btn").click(function(){
		...
		$.ajax({
			...
			success : function(result){
				window.location.href = "<%=basePath%>/trigger/search";
			}
		})
	})
</script>