...
public class DhPocessCategory {
    ...
    public DhPocessCategory() {
        
    }
    
    public DhPocessCategory(String categoryUid, String categoryParent, String categoryName, String categoryIcon) {
