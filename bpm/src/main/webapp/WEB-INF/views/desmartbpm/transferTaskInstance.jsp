...
<div class="layui-container" style="margin-top:20px;width:100%;">  
					...
					<div class="search_area">
						<div class="layui-row layui-form">
							<div class="layui-col-xs12" style="text-align:right;">
							    ...
							    <div class="layui-col-md3">
								<input type="text" placeholder="任务接收时间"  class="layui-input" id="taskInitDate-search">
								</div>
	...
	<div id="task-trun-off-div" class="display_container5_custom">
		<div class="display_content5_custom" style="height: 300px;">
			...
			<div class="middle1" style="height: 190px;">
...
<script type="text/javascript" src="<%=basePath%>/resources/desmartbpm/js/my/transferTaskInstance.js"></script>
