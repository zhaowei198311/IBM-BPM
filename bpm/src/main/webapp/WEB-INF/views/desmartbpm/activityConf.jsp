...
<!-- 参数映射弹框开始 -->
			...
			<div class="display_content3" style="height: 450px;">
				...
				<div class="foot">
					<button class="layui-btn"
						id="paramMapping_sureBtn">保存</button>
					<button class="layui-btn"
						id="paramMapping_cancelBtn" onclick="$('#triggerInterface_container').hide();">取消</button>
				</div>
			</div>
		</div>
    ...
    <script type="text/javascript" src="<%=basePath%>/resources/desmartbpm/js/my/activityConf.js"></script>
    <script type="text/javascript" src="<%=basePath%>/resources/desmartbpm/js/my/gatewaySet.js"></script>
