...
<link href="<%=basePath%>/resources/desmartbpm/css/modules/laydate/default/laydate.css" rel="stylesheet">
...
<script src="<%=basePath%>/resources/desmartbpm/js/jquery.fastLiveFilter.js"></script>
