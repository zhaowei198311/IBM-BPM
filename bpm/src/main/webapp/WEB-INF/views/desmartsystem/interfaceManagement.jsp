	...
	<div class="layui-container" style="margin-top: 20px; width: 100%;">
		<div class="search_area">
			<div class="layui-row layui-form">
				<form action="interfaces/queryDhInterfaceByTitle" method="post"
					onsubmit="return search(this);" id="interfaceSearch">
					<div class="layui-col-md2">
						<input id="interfaceName" type="text" placeholder="接口名称"
							class="layui-input" name="intTitle">
					</div>
					<div class="layui-col-md2">
					...
					<div class="layui-col-md2" style="text-align: right; width: 280px">
						...
						<button id="importBtn" class="layui-btn layui-btn-sm create_btn"
...
<!-- 						<th>接口描述</th> -->
	...
	<div class="display_container3" id="exposed_table_container">
		<div class="display_content2"
			style="top: 10%; margin: 0px; right: 10%; left: 10%;">
	...
	<div class="display_container">
		<div class="display_content2">
			...
			<div class="top" style=""titleTop">新增接口</div>
			...
			<form id="form1" class="layui-form" action=""
							...
							<div class="layui-inline">
								...
								<div class="layui-input-inline">
									<input type="text" id="intTitle" name="intTitle"
										lay-verify="intTitle" autocomplete="off"
							...
							<div class="layui-inline">
								...
								<div class="layui-input-inline">
									<input type="text" id="intUrl" name="intUrl"
										lay-verify="intUrl" autocomplete="off"
										class="layui-input required">
								</div>
							</div>
						</div>
					...
					<div class="layui-form-item layui-form-text">
						...
						<div class="layui-input-block">
							<textarea placeholder="" class="layui-textarea"
								id="intRequestXmlAdd" name="intRequestXml"></textarea>
						</div>
					</div>
				</div>
				...
				<div class="layui-col-md11 intResponseXml">
					<div class="layui-form-item layui-form-text">
						...
						<div class="layui-input-block">
							<textarea placeholder="" class="layui-textarea"
								id="intResponseXmlAdd" name="intResponseXml"></textarea>
						</div>
					</div>
				</div>
			...
			<div class="foot">
				...
				<button id="cancel_btn"
					class="layui-btn layui-btn-primary cancel_btn">取消</button>
			</div>
		</div>
	</div>
	...
	<div class="display_container4" id="exposed_table2_container">
		<div class="display_content2 boundInterfaceParameter"
			style="left: 47%;">
			<div class="top">绑定接口参数</div>
			<input id="intUid" type="hidden" />
			<form id="form2" class="layui-form" action="javascript:void(0);"
				style="margin-top: 30px;">
				<div class="layui-form-item">
					<div class="layui-row">
						<div class="layui-col-md6">
							...
							<div class="layui-input-inline">
								<input type="text" id="paraName" name="paraName"
									lay-verify="paraName" autocomplete="off"
									class="layui-input required">
							</div>
						</div>
						<div class="layui-col-md6">
				...
				<div class="layui-form-item">
					<div class="layui-row">
						<div class="layui-col-md6 paraSize">
							...
							<div class="layui-input-inline">
								<input type="text" id="paraSize" name="paraSize"
									lay-verify="paraSize" autocomplete="off"
						...
						<div class="layui-col-md6 dateFormat">
							...
							<div class="layui-input-inline">
								<input type="text" name="dateFormat" placeholder="例如:yyyy-MM-dd"
									class="layui-input">
							</div>
						</div>
				...
				<div id="arryParameterDiv">
					<div class="layui-form-item">
						<button class="layui-btn layui-btn-sm" type="button"
							onclick="addArrayParameter('add');"
							style="float: right; margin: 0 15px 0;">
							<i class="layui-icon">&#xe654;</i>
						</button>
					</div>
					<div class="middle1" style="width: 600px;">
						<table class="layui-table backlog_table" lay-even lay-skin="nob">
							<colgroup>
								<col width="15%">
								<col width="15%">
				...
				<div class="foot">
					...
					<button class="layui-btn layui-btn" lay-submit=""
						lay-filter="addParameterFilter">确定</button>
					<button id="cancel3_btn"
						class="layui-btn layui-btn-primary cancel3_btn">取消</button>
				</div>
			</form>
		</div>
	</div>
	<div class="display_container5" id="exposed_table3_container">
		<div class="display_content2">
			<div class="top">修改接口</div>
			<form id="updaArrayForm" class="layui-form"
				...
				<div class="layui-col-md11 intRequestXml1">
					<div class="layui-form-item layui-form-text">
						...
						<div class="layui-input-block">
							<textarea placeholder="" class="layui-textarea"
								id="intRequestXml2" name="intRequestXml"></textarea>
						</div>
					</div>
				</div>
				...
				<div class="layui-col-md11 intResponseXml1">
					<div class="layui-form-item layui-form-text">
						...
						<div class="layui-input-block">
							<textarea placeholder="" class="layui-textarea"
								id="intResponseXml2" name="intResponseXml"></textarea>
						</div>
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-inline">
						<label class="layui-form-label">接口状态:</label>
						<div class="layui-input-inline">
							<input id="intStatus2" type="checkbox" name="intStatus"
								lay-skin="switch" lay-filter="intStatusUpd" lay-text="启用|停用">
						</div>
					</div>
				</div>
	...
	<div class="display_container6" id="exposed_table3_container">
		<div class="display_content2  boundInterfaceParameter">
			<div class="top">修改绑定接口参数</div>
			<form class="layui-form" action="" style="margin-top: 30px;">
				<input id="intUid3" type="hidden" /> <input id="paraUid3"
					type="hidden" name="paraUid" />
				...
				<div class="layui-form-item">
					<div class="layui-row">
						...
						<div class="layui-col-md6">
							<label class="layui-form-label">参数类型:</label>
							<div class="layui-input-inline">
								<select name="paraType" class="require" id="paraType3"
									lay-filter="paraType3">
									<option value="String">String</option>
									<option value="Integer">Integer</option>
									<option value="Double">Double</option>
									<option value="Boolean">Boolean</option>
				...
				<div class="layui-form-item">
					<div class="layui-row">
						...
						<div class="layui-col-md6 dateFormat3" style="display: none;">
							<label class="layui-form-label">日期格式:</label>
							<div class="layui-input-inline">
								<input type="text" name="dateFormat" id="dateFormat3"
									placeholder="例如:yyyy-MM-dd" lay-verify="paraSize"
				...
				<div id="arryParameterDiv3">
					<div class="layui-form-item">
						<button class="layui-btn layui-btn-sm" type="button"
							onclick="addArrayParameter('update');"
							style="float: right; margin: 0 15px 0;">
							<i class="layui-icon">&#xe654;</i>
						</button>
					</div>
		...
		<form class="layui-form" id="updateInterfaceParameterForm"
			...
			<div class="layui-form-item">
				...
				<div class="layui-inline isMust2">
					<label class="layui-form-label">是否必须:</label>
					<div class="layui-input-inline">
						<input type="checkbox" name="isMust" id="isMust2"
							lay-skin="switch" lay-filter="isMustCheckUpd"
							lay-text="true|false" />
					</div>
				</div>
			</div>
