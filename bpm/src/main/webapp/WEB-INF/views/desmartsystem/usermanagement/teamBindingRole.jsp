...
$(function () {
    ...
    $("#removeRole_btn").click(function () {
        ...
        $(".right_li").each(function () {
        	var $li = $(this);
            if ($li.hasClass("colorli")) {
            	memberUids.push($(this).data("memberuid"));
            }
        });
...
function init() {
	$.ajax({
		...
		success: function(data){
			...
			$("#right_ul").empty();
			 $(data).each(function () {
				var str = '<li class="right_li" data-memberuid="' + this.memberUid + '" data-teamuid="' + this.teamUid + '" data-rolename="' + this.roleName + '">' +this.roleName + '</li>';
				$("#right_ul").append(str);
			 });
