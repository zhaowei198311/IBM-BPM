	...
	<script type="text/javascript">
		...
		function user_add_li(data,element,type){
			...
			$(data).each(function(index){
				var str='';
				str+='<li type="hidden" userUid="'+this.userUid+'" actcCanChooseUser="true"  onclick="selectClick(this)" name="userUid">'+this.userName+'('+this.userUid+')</li>';
				$ul.append(str);
			});
		};
			...
			$("#usersul li").each(function(){
				...
				if($userLi.hasClass('colorli')){
					...
					if($.inArray(userUid, userids)==-1){
						var str='';
						str+="<li userUid='"+userUid+"' actcCanChooseUser='"+actcCanChooseUser+"' onclick='selectClick(this);'>"+name;
						str+="</li>";
						$("#user_add").append(str);
					}
				}
