														...
														function() {
															...
															form
																	.on(
																			...
																			function(
																					data) {
																				var ckd = this.checked ? 'enabled'
																						: 'disabled';
																				document
																						.getElementById("intStatus").value = ckd;
																			})
														})
									})
														...
														function() {
															...
															form
																	.on(
																			...
																			function(
																					data) {
																				var ckd = this.checked ? 'true'
																						: 'false';
																				document
																						.getElementById("multiValue3").value = ckd;
																			})
															form
																	.on(
																			'switch(switch4)',
																			function(
																				...
																				var ckd = this.checked ? 'true'
																						: 'false';
																				document
																						.getElementById("isMust3").value = ckd;
																			})

															$(
																	"input[name='eCheck']:checked")
																	.each(
																			function() {
																						...
																						.ajax({
																							...
																							success : function(
																								...
																								$(
																										"#multiSeparator3")
																										.val(
																												result.multiSeparator);
																								if (result.multiValue == "true") {
																									document
																											.getElementById('multiValue3').checked = true;
																								} else {
																									document
																											.getElementById('multiValue3').checked = false;
																								}
																								if (result.isMust == "true") {
																									document
																											.getElementById('isMust3').checked = true;
																								} else {
																									document
																											.getElementById('isMust3').checked = false;
																								}
																								$(
																										"#intUid3")
																										.val(
...
function drawTable(pageInfo, data) {
	...
	for (var i = 0; i < list.length; i++) {
		...
		trs += '<tr>' + '<td>' + sortNum + '</td>' + '<td>' + meta.intTitle
				...
				+ meta.intCallMethod + '</td>' + '<td>' + status + '</td>'
				+ '<td>'
...
function drawTable2(pageInfo) {
	...
	for (var i = 0; i < list.length; i++) {
		...
		trs += '<tr><td><input id="paraUid" type="checkbox" name="eCheck" value="'
				+ meta.paraUid
				+ '" lay-skin="primary">'
				+ sortNum
				+ '</td>'
				...
				+ '<td>'
				+ meta.paraType
				+ '</td>' + '<td>' + meta.paraSize + '</td>'
				/*
				 * + '<td>' + meta.multiSeparator + '</td>' + '<td>' +
				 * multiValue + '</td>'
				 */
				+ '<td>' + isMust + '</td>' + '</tr>';
	}
