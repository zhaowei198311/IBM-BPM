    ...
    $.fn.extend({
        cronGen: function (options) {
            ...
            $b.popover({
                ...
                template: '<div class="popover" style="max-width:500px !important; width:400px;left:-341.656px;"><div class="arrow"></div><div class="popover-inner"><h3 class="popover-title"></h3><div class="popover-content"><p></p></div></div></div>',
